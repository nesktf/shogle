...
public:
  ...
  using deleter_type = gl_deleter<gl_buffer>;
...
public:
  ...
  enum mapping_access : gldefs::GLbitfield {
    ...
    MAP_ACCESS_WRITEONLY = 0x88B9, // GL_WRITE_ONLY
    MAP_ACCESS_READWRITE = 0x88BA, // GL_READ_WRITE
  };
...
public:
  ...
  static void deallocate_n(gl_context& gl, gl_buffer* buffs, size_t count) noexcept;
